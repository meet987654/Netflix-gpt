...
const VideoBackground = ({ movieId }) => {
  ...
  return (
    <div className='w-full '>
      ...
      src={`https://www.youtube.com/embed/${trailer.key}?autoplay=1&mute=1&controls=0&modestbranding=1&rel=0&showinfo=0&disablekb=1&fs=0&iv_load_policy=3&playsinline=1&loop=1&playlist=${trailer.key}`}
